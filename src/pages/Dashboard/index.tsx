...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
       ...
       const transactionsFormatadedValue =transactions.map(
       ...
       const balanceFormatadedValue = {
         income: formatValue(balance.income),
         outcome:formatValue(balance.outcome),
         total: formatValue(balance.total),
       }
       setTransactions(transactionsFormatadedValue);
       setBalance(balanceFormatadedValue);
    }
